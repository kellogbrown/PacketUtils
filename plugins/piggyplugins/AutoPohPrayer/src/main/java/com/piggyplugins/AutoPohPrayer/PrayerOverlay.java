...
import com.piggyplugins.AutoPohPrayer.UiLayoutOption;
...
public class PrayerOverlay extends OverlayPanel {
    ...
    @Inject
    public PrayerOverlay(PrayerPlugin plugin, PrayerConfig config) {
        this.plugin = plugin;
        this.config = config;
    ...
    private void addFullOverlay() {
        ...
        panelComponent.getChildren().add(TitleComponent.builder()
                .text("[B] Poh Prayer")
                .color(new Color(134, 196, 63, 255))
                .build());
        ...
        panelComponent.getChildren().add(LineComponent.builder()
                ...
                .right("1.0")
                .rightColor(new Color(134, 196, 63, 255))
                .build());
    ...
    private void addSimpleOverlay() {
        ...
        String title = "[B] Poh Prayer v1.0";
