...
import com.piggyplugins.AutoSandStone.UiLayoutOption;
...
public class SandStoneOverlay extends OverlayPanel {

    private final SandStonePlugin plugin;

    @Inject
    public SandStoneOverlay(SandStonePlugin plugin) {
        this.plugin = plugin;
