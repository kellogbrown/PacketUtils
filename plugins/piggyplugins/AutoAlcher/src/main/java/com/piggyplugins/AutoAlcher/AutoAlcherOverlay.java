...
public class AutoAlcherOverlay extends OverlayPanel {
    private final AutoAlcherPlugin plugin;

    @Inject
    public AutoAlcherOverlay(AutoAlcherPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    private void addFullOverlay() {
        panelComponent.setPreferredSize(new Dimension(150, 100)); // Adjust as needed
