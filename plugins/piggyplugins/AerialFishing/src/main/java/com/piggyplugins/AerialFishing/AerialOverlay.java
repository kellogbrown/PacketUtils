package com.piggyplugins.AerialFishing;


import com.google.inject.Inject;
import com.piggyplugins.AerialFishing.Enums.UiLayoutOption;
...
public class AerialOverlay extends OverlayPanel {
    ...
    @Inject
    public AerialOverlay(AerialPlugin plugin) {
        this.plugin = plugin;
    ...
    private void addSimpleOverlay() {
        ...
        String title = "[B] Aerial Fishing v1.0";
