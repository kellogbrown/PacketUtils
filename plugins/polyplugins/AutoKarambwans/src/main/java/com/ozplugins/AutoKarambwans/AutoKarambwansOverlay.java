...
@Slf4j
@Singleton
class AutoKarambwansOverlay extends OverlayPanel {
    private final AutoKarambwansPlugin plugin;
    private final AutoKarambwansConfiguration config;
    ...
    @Inject
    private AutoKarambwansOverlay(final Client client, final AutoKarambwansPlugin plugin, final AutoKarambwansConfiguration config) {
        super(plugin);
